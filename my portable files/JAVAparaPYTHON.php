...
$colocar1 = "print";   // Palavra que ficara no lugar
...
$colocar2 = "\"\"\"VARIAVEL\"\"\" = int(input(\"\") #Ponha o nome da sua variavel ali atras <= e delete o que sobrou antes dela(apague as aspas da variavel)";
//Obtem o conteudo do arquivo
...
$procurar223 = ".nextFloat();";   // Palavra que sera substituida
$colocar223 = "\"\"\"VARIAVEL\"\"\" = float(input(\"\")#Ponha o nome da sua variavel ali atras <= e delete o que sobrou antes dela(apague as aspas da variavel)";
//Obtem o conteudo do arquivo
...
$procurar3 = "import java.util.Scanner";   // Palavra que sera substituida

$colocar3 = "#Apague todas as bibliotecas que sobraram";
...
//Defina aqui as configuraçoes
$arquivo333 = "exemplo.txt";   // Arquivo para abrir
$procurar333 = "public static";   // Palavra que sera substituida
...
//Obtem o conteudo do arquivo
$obter333 = file_get_contents($arquivo333);
$novo333 = str_replace($procurar333, $colocar333, $obter333);



//Grava o novo texto (modificado) no arquivo
$gravar333 = fopen($arquivo333, "w");
fwrite($gravar333, $novo333);
fclose($gravar333);

//_____________________________________________________#include<stdio.h>________________________________________________

//Defina aqui as configuraçoes
$arquivo33322 = "exemplo.txt";   // Arquivo para abrir
$procurar33322 = "Scanner";   // Palavra que sera substituida
...
//Obtem o conteudo do arquivo
$obter33322 = file_get_contents($arquivo33322);
$novo33322 = str_replace($procurar33322, $colocar33322, $obter33322);



//Grava o novo texto (modificado) no arquivo
$gravar33322 = fopen($arquivo33322, "w");
fwrite($gravar33322, $novo33322);
fclose($gravar33322);
...
$procurar5 = "System.in.read();";   // Palavra que sera substituida
$colocar5 = "";
//Obtem o conteudo do arquivo
...
$colocar10 = "\"\"\"VARIAVEL\"\"\" = str(input(\"\")#Ponha o nome da sua variavel ali atras <= e delete o que sobrou antes dela(apague as aspas da variavel)";
//Obtem o conteudo do arquivo
