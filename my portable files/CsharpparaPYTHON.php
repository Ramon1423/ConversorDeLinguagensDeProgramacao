...
//Defina aqui as configuraçoes
$arquivo255 = "exemplo.txt";   // Arquivo para abrir
$procurar255 = "int.Parse(Console.ReadLine())";   // Palavra que sera substituida
$colocar255 = "input(\"\")";
//Obtem o conteudo do arquivo
$obter255 = file_get_contents($arquivo255);
$novo255 = str_replace($procurar255, $colocar255, $obter255);



//Grava o novo texto (modificado) no arquivo
$gravar255 = fopen($arquivo255, "w");
fwrite($gravar255, $novo255);
fclose($gravar255);
...
$procurar223 = "double.Parse(Console.ReadLine())";   // Palavra que sera substituida
$colocar223 = "float(input(\"\")";
//Obtem o conteudo do arquivo
...
$procurar3 = "using System;";   // Palavra que sera substituida

$colocar3 = "\"\"\"Apague todas as bibliotecas que sobraram e delete as linhas:

              namespace NOME DO ARQUIVO{
                  Class Program{
