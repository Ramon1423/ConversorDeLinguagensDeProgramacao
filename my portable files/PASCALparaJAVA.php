...
public static void main(String[]args){ 
              Scanner entrada = newScanner(System.in); //feche as chaves no final do codigo e delete este nome =>";   // Palavra que ficara no lugar
...
$colocar30 = "sua variavel = [entrada.nextInt(); /entrada.nextFloat(); / entrada.nextLine();]//escolha um dos três dentro do parenteses de acordo com o tipo da sua variavel";
...
$colocar62222 = "System.out.printf";
...
$colocar747 = "System.out.println(\"Press Enter to continue...\");
System.out.println(\"Press Enter to continue...\");
             System.in.read()";
...
//Defina aqui as configuraçoes
$arquivo7822 = "exemplo.txt";   // Arquivo para abrir
$procurar7822 = ",'";   // Palavra que sera substituida
$colocar7822 = "+\"";

//Obtem o conteudo do arquivo
$obter7822 = file_get_contents($arquivo7822);
$novo7822 = str_replace($procurar7822, $colocar7822, $obter7822);



//Grava o novo texto (modificado) no arquivo
$gravar7822 = fopen($arquivo7822, "w");
fwrite($gravar7822, $novo7822);
fclose($gravar7822);
...
$colocar44 = "int suavariavel[1000];//delete o que ficou atras de int";
//Obtem o conteudo do arquivo
...
$colocar440 = "char suavariavel[1000];//delete o que ficou atras de int";
//Obtem o conteudo do arquivo
...
$colocar80 = ";/* antes do nome da sua variavel ponha [int]*/";
...
$colocar8009 = ";/* antes do nome da sua variavel ponha [int]*/";
...
$colocar800 = ";/* antes do nome da sua variavel ponha [int]*/";
...
$colocar801 = ";/* antes do nome da sua variavel ponha [char]*/";
...
$colocar801123 = "/*Delete essa linha*/";
