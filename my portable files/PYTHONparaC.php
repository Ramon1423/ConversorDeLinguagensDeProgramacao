...
$colocar3 = "scanf(\"%[i,s,d,f,c]\", &SUAVARIAVEL);//digite o nome de sua variavel e apague o que sobrar antes do scanf... depois, ponha a letra da sua variavel depois do simbolo de porcentagem <<= Exemplo: scanf(\"%s\",&variavelstring);";
...
}FECHE ESSA CHAVE NO FINAL DO SEU CODIGO
...
$colocar6 = "/*ponha o ponto e virgula no final desse printf*/printf";
...
$colocar8334 = ",/*delete o parenteses que esta fechando ali na frente ==> e ponha porcentagem na frente das variaveis que estavam dentro desses mesmos parenteses*/ %";
...
//Defina aqui as configuraçoes
$arquivo833422 = "exemplo.txt";   // Arquivo para abrir
$procurar833422 = "\"+";   // Palavra que sera substituida
$colocar833422 = "/*ponha %s,%c,%i,%d ou %f no lugar desse comentario(s,c=> frase ou caracter i,f,d => numeros ou decimais)*/\",";

//Obtem o conteudo do arquivo
$obter833422 = file_get_contents($arquivo833422);
$novo833422 = str_replace($procurar833422, $colocar833422, $obter833422);



//Grava o novo texto (modificado) no arquivo
$gravar833422 = fopen($arquivo833422, "w");
fwrite($gravar833422, $novo833422);
fclose($gravar833422);
