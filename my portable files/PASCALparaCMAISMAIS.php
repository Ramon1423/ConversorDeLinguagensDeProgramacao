...
using namespace std;
           int main(){//feche a chave desse int main no final do codigo e delete este nome =>";   // Palavra que ficara no lugar
...
$colocar30 = "/*delete o parenteses que ficou => => =>*/cin >> ";
...
$colocar6 = "/*Delete somente os parenteses => => =>*/cout << ";
...
$colocar6222 = "/*Delete somente os parenteses => => =>*/cout << ";
...
$colocar62222 = "/*Delete somente os parenteses => => =>*/cout << ";
...
$colocar6123 = "/*Delete somente os parenteses => => =>*/cout << ";
...
$colocar782 = "/* ponha no lugar desse comentario => %[i,s,f,d,c]*/ /*depois das aspas que fecha a mensagem, ponha [\" ,nome da sua variavel]*/";
