...
$colocar1 = "//delete todas as bibliotecas que sobraram e se aparecer >variavel = numero;< fora do if, coloque variavel := numero";   // Palavra que ficara no lugar
...
//___________________________________________________int main()-class Program_________________________________________________

//Defina aqui as configuraçoes
$arquivo2 = "exemplo.txt";   // Arquivo para abrir
$procurar2 = "class Program";   // Palavra que sera substituida
$colocar2 = "Begin//Quando escrever seu codigo inteiro, em vez de terminar com chave(}), ponha (END.) e delete o que ficou aqui=>";
//Obtem o conteudo do arquivo
...
//___________________________________________________int main()-namespace_________________________________________________

//Defina aqui as configuraçoes
$arquivo212 = "exemplo.txt";   // Arquivo para abrir
$procurar212 = "namespace";   // Palavra que sera substituida
$colocar212 = "program Ramon Moratori//delete o que ficou aqui=> menos a chave";
//Obtem o conteudo do arquivo
$obter212 = file_get_contents($arquivo212);
$novo212 = str_replace($procurar212, $colocar212, $obter212);



//Grava o novo texto (modificado) no arquivo
$gravar212 = fopen($arquivo212, "w");
fwrite($gravar212, $novo212);
fclose($gravar212);

//___________________________________________________int main()-static void_________________________________________________

//Defina aqui as configuraçoes
$arquivo2122 = "exemplo.txt";   // Arquivo para abrir
$procurar2122 = "static void";   // Palavra que sera substituida
$colocar2122 = "//delete essa linha =>";
//Obtem o conteudo do arquivo
$obter2122 = file_get_contents($arquivo2122);
$novo2122 = str_replace($procurar2122, $colocar2122, $obter2122);



//Grava o novo texto (modificado) no arquivo
$gravar2122 = fopen($arquivo2122, "w");
fwrite($gravar2122, $novo2122);
fclose($gravar2122);
...
$procurar30 = "Console.ReadLine();";   // Palavra que sera substituida
$colocar30 = "read(/*sua variavel dentro desses parenteses*/);//delete o que sobrou antes de read.";
...
$procurar39 = "Console.ReadLine();";   // Palavra que sera substituida
$colocar39 = "read(/*sua variavel dentro desses parenteses*/);//delete o que sobrou antes de read.";
...
$colocar3 = "read(/*sua variavel dentro desses parenteses*/);//delete o que sobrou antes de read.";
...
$colocar4 = "read(/*sua variavel dentro desses parenteses*/);//delete o que sobrou antes de read.";
...
$colocar5 = "read(/*sua variavel dentro desses parenteses*/);//delete o que sobrou antes de read.";
...
$procurar55 = "double.Parse(Console.ReadLine());";   // Palavra que sera substituida
$colocar55 = "read(/*sua variavel dentro desses parenteses*/);//delete o que sobrou antes de read.";
...
$procurar7 = "Console.ReadKey();";   // Palavra que sera substituida
$colocar7 = "ReadKey;";
...
$colocar782 = "',//(sua variavel),'//delete esse nome de variavel e o + =>";
...
$colocar783 = "',//(sua variavel),'//delete esse nome de variavel e o + =>";
...
$procurar784 = "\"+";   // Palavra que sera substituida
$colocar784 = "',//(sua variavel),'//delete esse nome de variavel e o + =>";
...
$procurar785 = "\"+";   // Palavra que sera substituida
$colocar785 = "',//(sua variavel),'//delete esse nome de variavel e o + =>";
...
$procurar786 = "\"+";   // Palavra que sera substituida
$colocar786 = "',//(sua variavel),'//delete esse nome de variavel e o + =>";
...
$colocar801 = "/*Ponha depois do nome da sua variavel assim: [var variavel: char;]  */
/*se for uma string int, ponha: variavel: array [0...numero da string] of integer;/se for char, name : packed array [1... numero da string] of char*/;
var";
