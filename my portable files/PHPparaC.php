...
#include <stdlib.h>
#include <windows.h>// DELETE O QUE FICOU ANTES DAS BIBLIOTECAS
...
$colocar3 = "scanf(\"[%i] [%c] [%f] [%d] [%s]\", &suavariavel);//apague o que sobrar antes do scanf, ponha o nome da sua variavel no lugar de [suavariavel] <=...... e ponha a % da sua variavel sem os colchetes";
...
$colocar6 = "/*feche o parenteses e em vez de aspas simples(caso tenha), ponha aspas duplas*/printf(";
